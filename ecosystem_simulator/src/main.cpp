...
�
 Initialisation de l'aléatoire 
    ...
    std::cout << "
 🎮
 Démarrage du Simulateur d'Écosystème" << std::endl; 
    std::cout << "=======================================" << std::endl; 
...
⚙
 Initialisation 
    if (!engine.Initialize()) { 
        std::cerr << "
 ❌
 Erreur: Impossible d'initialiser le moteur de jeu" << std:
        return -1; 
    }
     
    std::cout << "
 ✅
 Moteur initialisé avec succès" << std::endl; 
    std::cout << "
 🎯
