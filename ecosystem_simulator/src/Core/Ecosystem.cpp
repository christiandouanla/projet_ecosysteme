...
{ 
    ...
    std::cout << "
 🌍
 Écosystème créé: " << width << "x" << height << std::endl; 
} 
// 🗑 DESTRUCTEUR 
Ecosystem::~Ecosystem() { 
    std::cout << "
 🌍
 Écosystème détruit (" << mEntities.size() << " entités nettoyé
 } 
// INITIALISATION 
void Ecosystem::Initialize(int initialHerbivores, int initialCarnivores, int initia
    mEntities.clear(); 
    mFoodSources.clear(); 
    ...
    std::cout << "
 🌱
 Écosystème initialisé avec " << mEntities.size() << " entités"
 } 
// 
�
�
